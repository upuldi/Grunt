//A grunt file is a node module, So it start as any node module
module.exports = function(grunt) {
	...
	//A simple task
	//A task can be executed with grunt <task_name> command
	...
	//Every grunt file should have a default task inorder to run the file with only grunt command
