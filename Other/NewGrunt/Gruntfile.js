module.exports = function(grunt){
    ...
    grunt.initConfig({
        ...
        "docular":{
            ...
            "docAPIOrder":["testAngularProject"],
            "docular_webapp_target":"docs",
            "groups":[
                {
                    "groupTitle":"testAngularProject",
                    "groupId":"testAngularProject",
                    "sections":[
                        {
                            "id":"testAngularProject",
    ...
    grunt.registerTask('dist',[ 'clean:dist','jshint','karma:unit-pre','concat','strip','ngtemplates','uglify:app','cssmin',"copy:maps",'karma:unit-post','plato']);
};
